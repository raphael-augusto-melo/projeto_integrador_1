...
import "./style_inp_pagbol.css";

export const InputFieldCodBol = ({ property1 = "default-state", className, keyFieldClassName, text, maxLength }) => {
  ...
  return (
    <div className={`input-field_pagbol ${state.property1} ${className}`}>
      <input
        type="text"
        maxLength={maxLength}
        value={state.value}
...
export default InputFieldCodBol;