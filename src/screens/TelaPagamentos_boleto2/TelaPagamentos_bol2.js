...
import { ExtInactive } from "../../components_pag_bol2/ExtInactive";
import { Group } from "../../components_pag_bol2/Group";
import "./style.css";

export const TelaPagamentos_bol2 = () => {
  return (
    <div className="tela-pagamentos_bol2">
      <div className="div">
...
export default TelaPagamentos_bol2;
