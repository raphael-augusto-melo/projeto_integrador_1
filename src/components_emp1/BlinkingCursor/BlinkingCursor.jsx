...
import "./style_bk_emp1.css";

export const BlinkingCursor = ({
  property1,
  className,
  propertyCursorOn = "https://c.animaapp.com/Dv9UGHf1/img/property-1-cursor-on@2x.png",
}) => {
  return (
    <img
      ...
      src={
        property1 === "cursor-OFF"
          ? "https://c.animaapp.com/Dv9UGHf1/img/property-1-cursor-off@2x.png"
          : propertyCursorOn
      }
    />
  );
